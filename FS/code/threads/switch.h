...
#ifdef x86
// 23-0127[j]: 對於 x86 Host machine 有以下定義
//             用於實現 Context Switch in switch.S
...
#define PCState         (_PC/4-1)   // 23-0128[j]: (32/4-1)=7
#define FPState         (_EBP/4-1)  // 23-0128[j]: (20/4-1)=4
#define InitialPCState  (_ESI/4-1)  // 23-0128[j]: (24/4-1)=5
#define InitialArgState (_EDX/4-1)  // 23-0128[j]: (16/4-1)=3
#define WhenDonePCState (_EDI/4-1)  // 23-0128[j]: (28/4-1)=6
#define StartupPCState  (_ECX/4-1)  // 23-0128[j]: (12/4-1)=2

#define InitialPC       %esi    // 23-0127[j]: 代表 esi暫存器的資料
#define InitialArg      %edx    // 23-0127[j]: 代表 edx暫存器的資料
#define WhenDonePC      %edi    // 23-0127[j]: 代表 edi暫存器的資料
#define StartupPC       %ecx    // 23-0127[j]: 代表 ecx暫存器的資料
